...
import { extractChartConfigByHourlyMetric, multiSelectCountries } from "@/lib/utils"
...
export default function DetailedView() {
  ...
  const [locations, setLocations] = useState<LocationOption[]>([locationParam as LocationOption])
